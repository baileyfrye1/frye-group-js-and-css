export default function footer() {
  ...
  return (footerContainer.innerHTML = `<section class="footer-content">
      <div class="logos">
        <img src="https://res.cloudinary.com/dlieh2u8a/image/upload/v1678212350/Frye%20Group%20Website%20Build/White_Frye_Group_Logo_lsdowt.png" alt="" class="frye-logo">
        <img src="https://res.cloudinary.com/dlieh2u8a/image/upload/v1730126355/Frye%20Group%20Website%20Build/simpli-hom-logo-white-01_lgm1e6.png" alt="" class="simplihom-logo">
      </div>
  ...
  <section id="copyright">
    <p id="year">
      © ${new Date().getFullYear()} Frye Group | LIC #347717 | simpliHŌM All rights reserved.
    </p>`);
}
